...
public class MessageSender {
    ...
    public MessageSender(TelegramBot bot, LogSender logger, AdminChatService adminChatService,
                         GlobalChatService globalChatService, Messages messages) {
        this.bot = bot;
     ...
     * @author ezuykow
     */
    public void sendForceReply(long chatId, String text, int replyToMessageId) {
    ...
    /**
     * Редактирует сообщение с id {@code msgId} в чате с id {@code chatId} - меняет текст на
     * {@code text}, клавиатуру на {@code kb}, или прикрепляет клавиатуру, если ее не было
     * @param chatId id чата
     * @param msgId id сообщения
     * @param text новый текст
     * @param kb клавиатура
